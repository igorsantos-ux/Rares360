    ...
    return (
        <div className="bg-white p-8 rounded-[2.5rem] border border-[#DEB587]/20 shadow-sm">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-6">
                <div>
                    <h3 className="font-extrabold text-xl text-slate-800">Repasses Médicos</h3>
                    <p className="text-sm font-bold text-slate-400">Gerencie as regras globais de repasse para os médicos.</p>
                </div>
                <button 
            ...
            {openDialog && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm">
                    <div className="bg-white rounded-[2rem] w-full max-w-md shadow-2xl p-8 relative">
                        ...
                        <h3 className="text-2xl font-black text-[#697D58] mb-6">Nova Regra de Repasse</h3>
                        ...
                        <div className="space-y-4">
                            <div className="space-y-1.5">
                                ...
                                >
                                    <option value="EXECUCAO">Na Execução do Procedimento</option>
                                    <option value="VENDA">Na Venda (Aprovação do Orçamento)</option>
                                </select>
                            </div>
                            <div className="space-y-1.5">
