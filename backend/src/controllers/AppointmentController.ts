...
export class AppointmentController {
    ...
    private static async checkConflicts(data: {
        ...
        if (professionalConflict) return { type: 'PROFESSIONAL', message: 'O profissional já possui um agendamento neste horário.' };
        ...
        if (roomId) {
            ...
            if (roomConflict) return { type: 'ROOM', message: 'A sala já está ocupada neste horário.' };
        }
        ...
        if (equipmentId) {
            ...
            if (equipmentConflict) return { type: 'EQUIPMENT', message: 'O equipamento já está alocado neste horário.' };
        }
     ...
     */
    private static async handleExecutionTriggers(appointment: any) {
        try {
