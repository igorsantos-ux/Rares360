...
export class ProcedureService {
    ...
    static async list(clinicId, params) {
    ...
    static async create(clinicId, data) {
        const finance = this.calculateFinance({
    ...
    static async update(id, clinicId, data) {
        const finance = this.calculateFinance({
            fixedCost: data.fixedCost || 0,
            variableCost: data.variableCost || 0,
            taxes: data.taxes || 0,
    ...
    static async getById(id, clinicId) {
    ...
    static async listPending(clinicId) {
    ...
    static async execute(id, clinicId) {
