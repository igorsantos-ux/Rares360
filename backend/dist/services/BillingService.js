...
export class BillingService {
    static async generatePDF(data) {
        return new Promise((resolve, reject) => {
            ...
            // Tabela 1: SERVIÇOS
            const drawTable = (title, items, top) => {
            ...
            doc.fillOpacity(1).fontSize(8).text('Obrigado por escolher nossos serviços! Caso tenha dúvidas sobre cobranças, entre em contato pelo e-mail acima.', 300, 785, { width: 250, align: 'right' });
            doc.end();
        });
    }
