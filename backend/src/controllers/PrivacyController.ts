/**
 * PrivacyController — Endpoints LGPD (Direitos dos Titulares)
 * 
 * Art. 18 LGPD: Confirmação, acesso, correção, anonimização, portabilidade,
 * eliminação, informação sobre compartilhamento.
 */
...
export class PrivacyController {
     ...
     */
    static async getMyData(req: any, res: Response) {
        try {
     ...
     */
    static async anonymizeMyData(req: any, res: Response) {
        try {
            const userId = req.user.id;
     ...
     */
    static async requestCorrection(req: any, res: Response) {
        try {
            const userId = req.user.id;
     ...
     */
    static async exportPortableData(req: any, res: Response) {
        try {
            const userId = req.user.id;
     ...
     */
    static async getConsentStatus(req: any, res: Response) {
        try {
            const userId = req.user.id;
     ...
     */
    static async registerConsent(req: any, res: Response) {
        try {
            const userId = req.user.id;
     ...
     */
    static async reportIncident(req: any, res: Response) {
        try {
