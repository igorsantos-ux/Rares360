...
const PATTERNS: Array<{ regex: RegExp; replacer: (match: string, ...groups: string[]) => string }> = [
...
export const secureLogger = {
    log: (...args: any[]) => console.log(...maskArgs(args)),
    info: (...args: any[]) => console.info(...maskArgs(args)),
    warn: (...args: any[]) => console.warn(...maskArgs(args)),
    error: (...args: any[]) => console.error(...maskArgs(args)),
    debug: (...args: any[]) => {
...
export function installSecureLogger(): void {
    if (process.env.NODE_ENV === 'production') {
        ...
        console.log = (...args: any[]) => originalConsole.log(...maskArgs(args));
        console.info = (...args: any[]) => originalConsole.info(...maskArgs(args));
        console.warn = (...args: any[]) => originalConsole.warn(...maskArgs(args));
        console.error = (...args: any[]) => originalConsole.error(...maskArgs(args));
